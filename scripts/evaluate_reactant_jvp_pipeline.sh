...

{
  ...
  printf '    "derivative_computation_time": %s,\n' "$(json_string "Unavailable; requires instrumented explicit Jacobian and generated JVP timing scopes.")"
  printf '    "sparse_assembly_time": %s,\n' "$(json_string "Unavailable for the current legacy baseline logs.")"
  printf '    "jvp_time": %s,\n' "$(json_string "Unavailable; current generated smokes report JacTimes counts but not callback wall time.")"
